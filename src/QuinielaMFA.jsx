  ...
  return (
    <div>
      ...
      {seccion("Predicciones","🎯",[
        ...
        ["Los resultados oficiales son los publicados al finalizar el tiempo reglamentario (90 minutos) para la fase de grupos. En la fase eliminatoria (Ronda de 32 en adelante), si el partido va a prórroga, se tomará el marcador al finalizar los 90 minutos + prórroga (120 min). No se consideran penales.",""],
